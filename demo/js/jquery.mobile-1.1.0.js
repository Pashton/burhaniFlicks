...
var sequentialHandler = createHandler( false ),
	simultaneousHandler = createHandler();
...
/* exposed $.mobile methods	 */
	...
	$.mobile.changePage = function( toPage, options ) {
		...
		//hide page to remove flickering.
		toPage.attr('style','opacity:0;');
